...
public class OrderTeenusService extends Service {
     ...
     *
     * @return
     *     returns CourierTeenus
     */
    @WebEndpoint(name = "OrderTeenusPort")
    public CourierTeenus getOrderTeenusPort() {
        return super.getPort(OrderTeenusPort, CourierTeenus.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderTeenusPort")
    public CourierTeenus getOrderTeenusPort(WebServiceFeature... features) {
        return super.getPort(OrderTeenusPort, CourierTeenus.class, features);
    }
